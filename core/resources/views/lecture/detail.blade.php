  ...
  $i = 0;  ?>
    ...
    <div class="row justify-content-center">
      <div class="col-md-10">
        ...
        @else
          ...
          <div  id="origine_{{$theme->id}}" class="">
            @foreach($saisie->salertes as $sAlerte)
              @if($sAlerte->alerte->theme->id === $theme->id)
    ...
    <div class="row mb-3">
      ...
      <div class="col-md-10 d-flex justify-content-end">
        <a id="listeOrigines" href="{{route('lecture.originesListe', session()->get('saisie_id'))}}" class="btn btn-otorange rounded-0 mr-1"><i class="fas fa-align-right"></i> Synthèse des causes</a>
