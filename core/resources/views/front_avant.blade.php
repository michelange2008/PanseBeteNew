  ...
  <div class="acces">
    ...
    <div class="row">
      ...
      <div class=" p-3 col-lg-8 bg-otobleu shadow">
        ...
        <p></p>
        <h5>Rendez-vous le 4 juin 2019 à l'ESA d'Angers</h5>
        <h5>au Colloque de restitution du casdar Otoveil <a href="http://www.itab.asso.fr/programmes/otoveil.php"> <i class='fa fa-external-link-alt'></i> </a></h5>
      </div>
    </div>
