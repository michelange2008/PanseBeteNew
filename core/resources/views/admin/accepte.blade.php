<div>
  ...
  <p>Dès maintenant, vous pouvez vous connnecter à <a href="https://panse-betes.fr">Panse-Bêtes</a> en utilisant comme identifiant le mail <strong>{{$nouveau_user->email}}</strong> et le mot de passe que vous aviez donné lors de votre inscription.</p>
