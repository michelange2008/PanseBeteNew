...
<div class="aide-contenu aide-contenu-saisie">
  ...
  <div id="texte-d-2" class="aide-contenu-container">
    ...
    <div class="aide-contenu-texte bg-aide-trans text-light">
      ...
      <p>cliquez sur <i class="fas fa-mouse-pointer"></i> </p>
      <p><span class="bg-otobleuclair aide-petit-bouton"> J'ai fini et je veux voir la synthèse</span></p>
      <p></p>
      <p>pour avoir un aperçu global de vos observations</p>
      <p></p>
      <div class="d-flex justify-content-end">
