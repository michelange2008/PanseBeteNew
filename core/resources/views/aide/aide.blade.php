...
@section('contenu')
  ...
  <div class="container-fluid alert alert-success">
    <h2> <img class="aide-icones" src="{{config('fichiers.images')}}instructions.svg" alt="mode d'emploi"> Panse-bêtes, comment démarrer ?</h2>
  </div>
  <div class="row">
    <div class="col-md-3"></div>
    <div class="col-md-5 m-3 p-3 border shadow">
      <p>A chaque page, vous trouverez une aide en cliquant sur <img class="aide-icones-petite" src="{{config('fichiers.images')}}aide.svg" alt="aide"> </p>
    ...
    <div class="col-md-7 m-3 p-3 border">
      ...
      <img class="img-fluid" src="{{config('fichiers.aide')}}aide_accueil.svg" alt="">
    </div>
    <div class="row">
      <div class="col-md-2">
      ...
      <div class="col-md-8 d-flex flex-row m-3 p-3 align-items-center border">
        ...
        <img class="pl-3 img-fluid" src="{{config('fichiers.aide')}}aide_nouvelle_saisie.svg" alt="">
      </div>
    </div>

    <div class="col-md-7  d-flex flex-row align-items-center m-3 p-3 border">
      <img class="img-fluid pr-3" src="{{config('fichiers.aide')}}aide_theme.svg" alt="">
      <p>Ce qui amène à une page qui liste les 7 pôles. Il faut choisir un pôle en cliquant sur son nom</p>
    </div>
    <div class="row">
      <div class="col-md-3"></div>
      <div class="col-md-5 m-3 p-3 border shadow">
        <p>Et pour la suite, vous trouverez de l'aide en cliquant sur <img class="aide-icones-petite" src="{{config('fichiers.images')}}aide.svg" alt="aide"> </p>
