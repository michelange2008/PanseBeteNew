...
<div class="aide-contenu ">
  ...
  <div id="texte-d-1" class="aide-contenu-container">
    ...
    <div class="aide-contenu-texte bg-aide-trans">
      <h3>Bravo !!!</h3>
      <p><i class="fas fa-laugh-wink"></i> Vous avez trouvé comment accéder à l'aide contextuelle !</p>
      <p></p>
      <p>En haut à droite, l'icone <i class="fas fa-window-close"></i> vous permettra de fermer cette fenêtre</p>
