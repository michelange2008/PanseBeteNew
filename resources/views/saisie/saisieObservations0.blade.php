...
@section('contenu')
  ...
  <div class="row justify-content-center">
    ...
    <div class="col-md-11">
      ...
      <form class="" action="{{ route('saisie.enregistre') }}" method="post">
        @csrf

        @foreach ($alertes as $theme => $alerte)

          <div class="ml-2 mt-3 d-flex flex-row align-items-center bg-otobleu">
            <img class="img-40" src="{{url('storage/img/saisie/'.$alerte[0]->theme_icone)}}" alt="">
            <h5>{{ ucfirst($theme) }}</h5>
          </div>
